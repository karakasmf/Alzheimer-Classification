...
from reve_pipeline.common.paths import WINDOW_DIR, RESULTS_ROOT, PARTICIPANTS_TXT
...
# =========================================================
# PARTICIPANTS_TXT is imported from reve_pipeline.common.paths
PARTICIPANTS_TXT = str(PARTICIPANTS_TXT)
TARGET_LABELS = ["A", "C"]
SEED = 42
...
def main():
    ...
    for _ in range(n_iterations):
        indices = rng_bs.choice(n_samples, n_samples, replace=True)
        m = compute_metrics(y_true_all[indices], y_pred_all[indices], n_classes)
    ...
    out = {
        ...
        "global_metrics_formatted": formatted_metrics
    }
    ...
    print(f"[{tag}] Global metrics (Metric \u00b1 Std):")
